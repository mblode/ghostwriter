...
They run on an authenticated Codex or Claude Code CLI. No API keys, no service, no database. Your writing stays on your machine.
...
Replace the invented demo files with your own: edit `soul.md` (your cross-platform core) and `slack.md` (one platform's register), adding any `<platform>.md` you need. Or point `train-ghostwriter` at your samples and it derives them. A platform file is required; `soul.md` is optional.
